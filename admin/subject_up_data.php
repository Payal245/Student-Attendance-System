...
<form method="POST">
<h1 class="text-center" style="padding-top:15px;">Update Subject</h1>
...
<input class="btn btn-primary" type="submit" value="Update Subject" name="upd" style="width:300px;margin-top:16px; margin-left:35">
</form>
</div>	
</div>
...
if(isset($_POST['upd'])){
	...
	$quer="UPDATE subject_detail SET dep_fk='$dep_fk',sem_fk='$sem_fk',sub_name='$sub_name'WHERE sub_id=$val";
